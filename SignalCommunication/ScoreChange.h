...
public:
    ...
    enum SystemChanged
    {
        ...
        NoteCreated,          //(GlobalIdType id, GlobalIdType staffId, StaffCoords coords, NoteValue noteValue)
        PauseCreated,         //(GlobalIdType id, GlobalIdType staffId, StaffCoords coords, NoteValue pauseValue)
